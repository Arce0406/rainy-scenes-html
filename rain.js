...
const num = '8';
const path_bg = `img/hachi/bg${num}.jpg`;
const path_fg = `img/hachi/fg${num}.jpg`;
...
class EffectCanvas {
  ...
  constructor(width, height, loader) {
    // var myView = document.getElementById('rainCanvas');

    // Create and configure the renderer
    this.renderer = new PIXI.autoDetectRenderer(width, height, {
      antialias: false,
      transparent: false,
      view: document.getElementById('rainCanvas')
    });
    ...
    shaderData.uniforms.uTextureDropShine.value = loader.resources[path_shine].texture;
    shaderData.uniforms.uTextureBackground.value = loader.resources[path_bg].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources[path_fg].texture;
    shaderData.uniforms.vTextureSize.value = [
      loader.resources[path_bg].texture.width,
      loader.resources[path_bg].texture.height,
    ];
...
class DropletManager {
  ...
  constructor(stage, loader) {
    ...
    this.dropletSmallTexture = loader.resources[path_alpha].texture;
    this.dropletLargeTexture = loader.resources[path_alpha].texture;
